...
- **Manual UI** — after big chat, username, or extension changes, run `.cursor/skills/verify-chat-ui/SKILL.md` (link chat + installed extension, computerUse)
...
- **Manual product check:** after big chat/UI/extension changes, follow `.cursor/skills/verify-chat-ui/SKILL.md` (computerUse: shareable-link room **and** installed Page Chat overlay)
